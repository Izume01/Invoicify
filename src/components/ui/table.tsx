...
function Table({ className, ...props }: React.ComponentProps<"table">) {
  return (
    <div
      ...
      className="relative w-full overflow-x-auto rounded-xl border border-border/70 bg-card/35"
    >
      <table
        data-slot="table"
...
function TableFooter({ className, ...props }: React.ComponentProps<"tfoot">) {
  return (
    <tfoot
      ...
      className={cn(
        "bg-muted/30 border-border/70 border-t font-medium [&>tr]:last:border-b-0",
        className
      )}
      {...props}
    />
...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "border-border/55 hover:bg-muted/35 data-[state=selected]:bg-primary/14 border-b transition-colors duration-200",
        className
      )}
      {...props}
    />
